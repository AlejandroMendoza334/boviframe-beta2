...
class _NewsAdminCreateScreenState extends State<NewsAdminCreateScreen> {
  ...
  // Mostrar un selector de fecha para elegir la fecha de la noticia
  ...
  // Se llama al pulsar "Guardar Noticia"
  Future<void> _submitForm() async {
    if (!_formKey.currentState!.validate()) return;
    _formKey.currentState!.save();

    // Verifica que el usuario autenticado sea el admin
    ...
    // Mostrar un spinner mientras sube la imagen y guarda en Firestore
    showDialog(
      context: context,
    ...
    try {
      // Si seleccionaste una imagen, la sube primero
      if (_pickedImage != null) {
        _imageUrl = await _uploadImage(_pickedImage!);
      }

      // Crea el documento en la colección "news"
      ...
      // Regresa a la pantalla anterior (lista de noticias)
      Navigator.of(context).pop();
    } catch (e) {
      // En caso de error, cierra el spinner y muestra mensaje
      Navigator.of(context).pop();
      ScaffoldMessenger.of(context).showSnackBar(
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                validator: (v) => (v == null || v.isEmpty) ? 'Selecciona categoría' : null,
              ),
              const SizedBox(height: 16),

              // Vista previa de la imagen (si ya seleccionaste)
              ...
              TextFormField(
                ...
                maxLines: 6,
                validator: (v) => (v == null || v.isEmpty) ? 'Ingresa el contenido' : null,
